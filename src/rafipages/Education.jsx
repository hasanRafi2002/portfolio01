        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div className="space-y-6">
            ...
            {educationData.map((edu) => (
              <motion.div key={edu.id} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={fadeUp} className="glass glass-hover p-6 rounded-xl">
          ...
          <div className="space-y-6">
            ...
            {certificationsData.map((cert, i) => (
              <motion.div key={cert.id} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={fadeUp} transition={{ delay: i * 0.1 }} className="glass glass-hover p-6 rounded-xl">
                <div className="flex items-start gap-4">
