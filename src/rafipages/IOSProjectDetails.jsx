...
const iosProjects = [
  {
    ...
    shortDescription:
      "A task management iOS app built using Swift, MVVM, and Firebase.",
    longDescription:
      "Smart Task Manager is a productivity-focused iOS application designed to help users manage daily tasks efficiently. The app follows MVVM architecture, ensuring a clean separation of concerns and scalability. Firebase Authentication and Firestore enable real-time synchronization across devices.",
    screenshots: [
  ...
  },
  {
    ...
    shortDescription:
      "An iOS app consuming REST APIs using URLSession and async/await.",
    longDescription:
      "This project demonstrates real-world API consumption in iOS. The app fetches data from public REST APIs, handles loading states, errors, pagination, and displays results efficiently using Swift concurrency.",
    screenshots: [
  ...
  },
  {
    ...
    shortDescription:
      "Swift-based backend using Vapor and PostgreSQL for iOS clients.",
    longDescription:
      "This project focuses on backend development using Vapor. RESTful APIs were built to support iOS clients with authentication and CRUD operations. PostgreSQL was used as the primary database with a clean relational schema.",
    screenshots: [
    ...
    features: [
      ...
      "Designed for iOS client consumption",
...
>
  ...
  return (
    <div className="min-h-screen px-4 py-10 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900">
  ...
  Go Back
        ...
        <div className="mt-10">
          ...
          <ul className="grid gap-3 mt-4 md:grid-cols-2">
            {project.features.map((f, i) => (
              ...
              >
                <CheckCircle className="w-5 h-5 mt-1 text-blue-500" />
                {f}
              </li>
            ))}
          </ul>
        ...
        <div className="mt-10">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 text-white bg-gray-800 rounded-lg hover:bg-gray-900"
          >
